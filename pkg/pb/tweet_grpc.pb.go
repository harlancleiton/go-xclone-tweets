...
const (
	TweetService_Create_FullMethodName = "/TweetService/Create"
)
...
type TweetServiceClient interface {
	Create(ctx context.Context, in *CreateTweetRequest, opts ...grpc.CallOption) (*TweetResponse, error)
}
...
func (c *tweetServiceClient) Create(ctx context.Context, in *CreateTweetRequest, opts ...grpc.CallOption) (*TweetResponse, error) {
	out := new(TweetResponse)
	err := c.cc.Invoke(ctx, TweetService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TweetServiceServer interface {
	Create(context.Context, *CreateTweetRequest) (*TweetResponse, error)
...
func (UnimplementedTweetServiceServer) Create(context.Context, *CreateTweetRequest) (*TweetResponse, error) {
...
func _TweetService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TweetService_Create_FullMethodName,
	}
